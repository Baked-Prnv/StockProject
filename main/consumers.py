...
class StockConsumer(AsyncWebsocketConsumer):
    ...
    def addToCeleryBeat(self, stockpicker):
        ...
        if len(task)>0:
            ...
            task = PeriodicTask.objects.create(interval = schedule, name='every-10-seconds', task="main.tasks.update_stocks", args = json.dumps([stockpicker]))
    ...
    async def send_stock_update(self, event):
        ...
        user_stock = await self.selectUserStocks()
